(define 
    ...
    (:init 
		...
		; caminoEntre_Poss sentidos opuestos
		(caminoEntre_Pos puerto almacen)
		(caminoEntre_Pos fabrica_2 puerto)
		(caminoEntre_Pos fabrica_1 fabrica_2)
		(caminoEntre_Pos almacen fabrica_1)
        ...
        (= (maxLoad_Ubicacion fabrica_2) 3) ; Condicion de la fabrica 2
